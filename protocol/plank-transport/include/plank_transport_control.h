...
typedef enum PlankTransportControlType {
    ...
    PLANK_TRANSPORT_CONTROL_SET_CAMERA = 10,
    PLANK_TRANSPORT_CONTROL_CAMERA_APPLIED = 11,
    PLANK_TRANSPORT_CONTROL_CAMERA_KEYFRAME = 12,
} PlankTransportControlType;

#define PLANK_TRANSPORT_CAMERA_ENABLED 1u
#define PLANK_TRANSPORT_CAMERA_OFF 0u
#define PLANK_TRANSPORT_CAMERA_PENDING 1u
#define PLANK_TRANSPORT_CAMERA_ACTIVE 2u
#define PLANK_TRANSPORT_CAMERA_UNAVAILABLE 3u
