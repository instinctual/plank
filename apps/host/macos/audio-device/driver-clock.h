...
// timestamps. Use the measured built-in output's 15840-frame period.
// This describes the device clock, not an IO buffer or media
// packet: the HAL interpolates intervening sample positions at the fixed rate.
enum { PLANKAudioZeroTimeStampPeriod = 15840 };
