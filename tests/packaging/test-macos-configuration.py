...
class Configuration(unittest.TestCase):
    ...
    def test_client_installer_payload_roundtrip(self):
        ...
        shutil.copyfile(ROOT / "packaging/client/macos/pkg-postinstall", scripts / "postinstall")
        ...
        self.assertEqual(postinstall[0].read_bytes(), (scripts / "postinstall").read_bytes())
        self.assertEqual(postinstall[0].stat().st_mode & 0o777, 0o755)
